...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    if(isset($_POST['tambah'])) {
        // Tambah simpanan hari raya baru
        ...
        try {
            ...
            // Insert simpanan
            $stmt = $conn->prepare("INSERT INTO simpanan (nasabah_id, jumlah, jenis, tanggal, keterangan) VALUES (?, ?, 'hari_raya', ?, ?)");
            ...
            $conn->commit();
            $success = "Simpanan hari raya berhasil ditambahkan!";
    ...
    if(isset($_POST['edit'])) {
        ...
        try {
            ...
            $conn->commit();
            $success = "Simpanan hari raya berhasil diupdate!";
            header("Location: " . $_SERVER['PHP_SELF']);
            exit();
        } catch(PDOException $e) {
            $conn->rollBack();
    ...
    if(isset($_POST['hapus'])) {
        ...
        try {
            ...
            $conn->commit();
            $success = "Simpanan hari raya berhasil dihapus!";
            header("Location: " . $_SERVER['PHP_SELF']);
            exit();
        } catch(PDOException $e) {
            $conn->rollBack();
...
// Ambil data simpanan hari raya
$stmt = $conn->query("SELECT s.*, n.nama_lengkap FROM simpanan s JOIN nasabah n ON s.nasabah_id = n.id WHERE s.jenis = 'hari_raya' ORDER BY s.tanggal DESC, s.created_at DESC");
...
<?php include '../includes/header.php'; ?>
    ...
    <!-- <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#tambahModal">
        <i class="fas fa-plus"></i> Tambah Simpanan Hari Raya
    </button> -->

    <div class="card">
        <div class="card-header">
                    <h3 class="card-title">Daftar Simpanan Hari Raya</h3>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Edit Simpanan Hari Raya</h5>
...
<div class="modal fade" id="tambahModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Simpanan Hari Raya</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    document.querySelectorAll('.delete-btn').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                text: 'Data simpanan hari raya akan dihapus dan saldo nasabah akan dikembalikan!',
                icon: 'warning',
